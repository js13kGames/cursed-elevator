...
js13k.Audio = {
	...
	DING: [.8,0,783.99,.07,,1.6,1,2,,,,,,,,,,.3,.15],
	DOORS: [.4,0,164.8138,.2,1.1,.2,3,4,,,,,,,,.1,,,.5,,-562],
	...
	STEP: [.2,0,453,,.07,.008,4,1.6,-6,-2,,,,.4,,.4,.02,.55,.04,,1424],
	...
	THUD: [2.1,0,453,.03,.03,.16,4,3.7,-1,,,,,.2,1.3,.2,.1,.52,.07],
